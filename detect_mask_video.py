...
count = 1 
snapPath = "\John Low\Programming\Python\Mask Detection\snapshot"
timeF = 90
pixels = 50 # Minimum number of pixels each face should be apart.
...
while True:
	...
	#social distancing detect
    violation = violate
    warning = "Social Distancing: No" if violation == True else "Social Distancing: Yes"
    warningcolor = (0, 255, 0) if violation == False else (0, 0, 255)
    cv2.putText(frame, warning, (50,50), cv2.FONT_HERSHEY_SIMPLEX, 0.45, warningcolor, 2)
